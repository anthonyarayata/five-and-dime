    ...
    return (
        <div className='pt-8 bg-zinc-950 text-white'>
            <div className="grid grid-cols-3 grid-rows-3 gap-2">
                <div className='px-4 col-span-1 row-span-1 row-start-1 grid grid-rows-3'>
                ...
                <div className="px-4 col-span-full row-span-1 row-start-3 grid grid-cols-2">
                    ...
                    <div className='col-span-1 col-start-2 flex justify-end items-center text-xs font-iconaSans'>
